...
<div class="wrap">
    ...
    <form action="/shopping/update" method="post" enctype="multipart/form-data">
        ...
        <input type="text" id="item" name="item" value = "${shDto.item}" readonly><br><br>
        
        <label for="price">가격:</label>
        <input type="text" id="price" name="price" value = "${shDto.price}" maxlength = "20"><br><br>
        
        <label for="ea">수량:</label>
        <input type="text" id="ea" name="ea" value = "${shDto.ea}" maxlength = "6"><br><br>
        
        <label for="sh_content">상품 설명:</label><br>
        <textarea id="sh_content" name="sh_content" rows="4" cols="50">${shDto.sh_content}</textarea><br><br>
